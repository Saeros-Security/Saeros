...
public class TestData_Matched_2 : TestData
{
    public TestData_Matched_2() : base(_5b0b75dc_9190_4047_b9a8_14164cee8a31.YamlRule.Yaml)
    {
        for (int i = 0; i < 6; i++)
        {
        ...
        Match = true;
        Details = "Type: 2 - INTERACTIVE \u00a6 TgtUser: Auditor \u00a6 SrcComp: N/A \u00a6 SrcIP: 127.0.0.1 \u00a6 AuthPkg: N/A \u00a6 Proc: N/A";
    }
}