...
{
    public TestData_Matched() : base(f2b2d6f5_92ed_d0f5_25fe_38019bd55906.YamlRule.Yaml)
    {
        ...
        Match = true;
        Details = "Cmdline: powershell.exe  -NoProfile -Command \"& {if($PSVersionTable.PSVersion.Major -ge 3){Import-Module 'C:\\Program Files\\Microsoft Visual Studio\\2022\\Community\\Common7\\Tools\\\\Microsoft.VisualStudio.DevShell.dll'; Send-VsDevShellTelemetry -NewInstanceType Cmd; }}\"  \u00a6 Proc: C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe \u00a6 PID: N/A \u00a6 User: N/A \u00a6 LID: N/A";
    }
}