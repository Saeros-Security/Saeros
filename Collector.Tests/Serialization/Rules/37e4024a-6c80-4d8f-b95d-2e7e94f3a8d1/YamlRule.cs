...
{
    public const string Yaml = @"title: Outbound Network Connection Initiated By Microsoft Dialer
id: fa5330d2-19f1-4167-52a0-fb622b6425f8
related:
...
detection:
    network_connection:
        ...
        Channel: Security
    selection:
        Application|endswith: :\Windows\System32\dialer.exe
        Direction: '%%14593'
