namespace Collector.Tests.Conversion.Rules.a762e74f_4dce_477c_b023_4ed81df600f9;

public class SigmaRule : IConversionRule
{
    public string Yaml { get; } = @"title: Scheduled Task Created - FileCreation
...
level: low";
    ...
    public string Conversion { get; } = @"title: Scheduled Task Created - FileCreation
id: 3280324e-bcc3-8905-da91-478bd4d7c99c
related:
- id: a762e74f-4dce-477c-b023-4ed81df600f9
- type: derived
status: test
