namespace Collector.Tests.Conversion.Rules._19b041f6_e583_40dc_b842_d6fa8011493f;

public class SigmaRule : IConversionRule
{
    public string Yaml { get; } = @"title: HackTool Named File Stream Created
...
level: high";
    ...
    public string Conversion { get; } = @"title: HackTool Named File Stream Created
id: c6dbb789-b528-40fd-607f-2bad5844030f
related:
- id: 19b041f6-e583-40dc-b842-d6fa8011493f
- type: derived
status: test
