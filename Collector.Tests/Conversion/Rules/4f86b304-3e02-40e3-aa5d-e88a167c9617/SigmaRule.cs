namespace Collector.Tests.Conversion.Rules._4f86b304_3e02_40e3_aa5d_e88a167c9617;

public class SigmaRule : IConversionRule
{
    public string Yaml { get; } = @"title: Scheduled Task Deletion
...
level: low";
    ...
    public string Conversion { get; } = @"title: Scheduled Task Deletion
id: 6b8d9b22-dc44-724c-9d08-4bd39db76167
related:
- id: 4f86b304-3e02-40e3-aa5d-e88a167c9617
- type: derived
status: test
