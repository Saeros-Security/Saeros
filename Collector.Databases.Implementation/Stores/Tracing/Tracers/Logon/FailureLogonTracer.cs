...
public class FailureLogonTracer(long count, string targetAccount, ISet<string> targetComputer, ISet<string> logonType, ISet<string> sourceComputer, ISet<string> sourceIpAddress) : Tracer
{
